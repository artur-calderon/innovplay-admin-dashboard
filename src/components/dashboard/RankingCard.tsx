        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-2 sm:p-3 mb-4 border-2 border-blue-200 flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1 sm:gap-2 mt-1">
              <Badge className="bg-blue-100 text-blue-800 text-xs px-1 sm:px-2 py-1 flex-shrink-0">{ranking.posicaoAtual}º lugar</Badge>
              {ranking.mudancaPosicao !== 0 && (
                <span className={`text-xs flex items-center gap-1 font-medium ${ranking.mudancaPosicao > 0 ? 'text-green-600' : 'text-red-600'} flex-shrink-0`}>
          ...
          <div className="text-right flex-shrink-0">
            <div className="text-lg sm:text-2xl font-bold text-blue-600 leading-none">{ranking.pontos}</div>
