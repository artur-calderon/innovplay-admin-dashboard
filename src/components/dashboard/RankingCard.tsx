...
import { Trophy, Target, ArrowUp, ArrowDown, Info } from "lucide-react";
...
const RankingCard: React.FC<RankingCardProps> = ({ 
  ...
  // Verificar se há dados de ranking disponíveis
  const hasData = ranking.lista.length > 0 && ranking.posicaoAtual > 0;
      ...
      <CardContent>
        {!hasData ? (
          ...
          <>
            ...
            {/* Próximo Objetivo */}
            {ranking.proximoObjetivo.progresso > 0 && (
