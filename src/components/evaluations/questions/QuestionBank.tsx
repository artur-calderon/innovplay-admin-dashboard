...
export default function QuestionBank({
  ...
  const fetchQuestions = async () => {
    try {
      ...
      setError("Erro ao carregar questões do banco. Verifique sua conexão.");
      setQuestions([]);
      toast({
        title: "Erro",
  ...
  const sortQuestions = (questions: Question[], sortBy: string): Question[] => {
    ...
    return [...questions].sort((a, b) => {
      ...
      switch (sortOption.key) {
        ...
        case 'value':
          aValue = parseFloat(String(a.value) || '0') || 0;
          bValue = parseFloat(String(b.value) || '0') || 0;
  ...
  }, [questions, debouncedSearchTerm, sortBy, selectedSubjectId, gradeId, gradeName, grades]);
