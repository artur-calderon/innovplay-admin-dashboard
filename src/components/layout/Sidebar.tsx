      ...
      <li>
        {link.label === "Sair" ? (
          <button
            ...
            className={
              `sidebar-link w-full text-left flex items-center gap-2 ${currentPath === link.href ? "active" : ""
              }`}
          >
            <link.icon size={20} />
          ...
          <button
            ...
            className={
              `sidebar-link w-full text-left flex items-center justify-between gap-2 ${isActive ? "active" : ""
              }`}
          >
          ...
          <Link
            to={link.href || "#"}
            className={
              `sidebar-link flex items-center gap-2 ${currentPath === link.href ? "active" : ""
              }`}
          >
            <link.icon size={20} />
            {!isCollapsed && <span>{link.label}</span>}
