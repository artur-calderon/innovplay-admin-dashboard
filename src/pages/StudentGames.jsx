    ...
    return (
        <div className="container mx-auto py-6 space-y-6 min-h-screen">
            <div className="animate-fade-in-up">
                <h2 className="text-3xl font-bold tracking-tight flex items-center gap-3" id="games-page-title">
                ...
                <p className="text-muted-foreground font-medium">Jogue e aprenda com seus jogos educativos</p>
            </div>
